...
(async function() {
  ...
  describe('Beru.ru authorization', function () {
    ...
    it('Check the error returns when unexisting login is submitted', async () => {
      await driver.get('https://beru.ru/login?retpath=https%3A%2F%2Fberu.ru%2F%3Fncrnd%3D8255');
    ...
    it('Check the error returns when incorrect login is submitted', async () => {
      await driver.get('https://beru.ru/login?retpath=https%3A%2F%2Fberu.ru%2F%3Fncrnd%3D8255');
    ...
    it('Check the error returns when no login is submitted', async () => {
      await driver.get('https://beru.ru/login?retpath=https%3A%2F%2Fberu.ru%2F%3Fncrnd%3D8255');
    ...
    it('Check the back button on the login page returns to the site without authetification', async () => {
      await driver.get('https://beru.ru/login?retpath=https%3A%2F%2Fberu.ru%2F%3Fncrnd%3D8255');
    ...
    it('Check the error returns when incorreсt password is submitted', async () => {
      await driver.get('https://beru.ru/login?retpath=https%3A%2F%2Fberu.ru%2F%3Fncrnd%3D8255');
    ...
    it('Check the error returns when no password is submitted', async () => {
      await driver.get('https://beru.ru/login?retpath=https%3A%2F%2Fberu.ru%2F%3Fncrnd%3D8255');
